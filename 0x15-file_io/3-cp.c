...
/*
 * error_file: function checks if a file is open and handle errors
 * @file_from: initial file to copy from and to check
 * @file_to: files destination to copy to
...
/*
 * main - function copies content of a file from one to another
 * @argc: argument count
 * @argv: argument vector
 * Return: 0 on success.
 */
